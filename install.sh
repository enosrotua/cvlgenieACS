...
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}==================== GENIEACS ORIGINAL INSTALLER ===========================${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}${NC}"
echo -e "${GREEN}Autoinstall GenieACS Original Theme v1.2.13.${NC}"
echo -e "${GREEN}${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo -e "${RED}${NC}"
...
# Install Configuration and Parameters
echo -e "${GREEN}================== Install Configuration ==================${NC}"
echo -e "${GREEN}Sekarang install parameter dan konfigurasi. Apakah anda ingin melanjutkan? (y/n)${NC}"
read confirmation
...
echo -e "${GREEN}=================== Original Theme Applied =======================${NC}"
...
echo -e "${YELLOW}4. Original theme sudah diterapkan${NC}"
echo -e "${YELLOW}============================================================================${NC}"